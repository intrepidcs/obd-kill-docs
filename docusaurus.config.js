...
const config = {
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: '/',
          editUrl:
            'https://github.com/intrepidcs/obd-kill-docs/blob/main/',
        },
        // blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/obd-kill-social-card.jpg',
      navbar: {
        title: 'OBD-Kill',
        logo: {
          alt: 'OBD-Kill Logo',
        ...
        items: [
          ...
          {
            href: 'https://github.com/intrepidcs/obd-kill-docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
