...
description: Discover the OBD-Kill tool by Intrepid Control Systems, designed with CAN Tx, LEDs, PWM, and Raspberry Pi Pico support for hacking, diagnostics, and more.
keywords: [OBD-Kill, Intrepid Control Systems, CAN Tx, Raspberry Pi Pico, car hacking, PWM, LEDs, programmable buttons, CHV badge, Defcon, automotive diagnostics]
sidebar_position: 3
...
![OBD-KIll front view](./assets/OBD-KIll-front-view.png "OBD-KIll front view")
<figcaption>OBD-KIll front view</figcaption>
</figure>
</div>
...
![OBD-KIll back view](./assets/OBD-KIll-back-view.png "OBD-KIll back view")
<figcaption>OBD-KIll back view</figcaption>
</figure>
</div>
